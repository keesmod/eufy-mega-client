...
The **Dependency security** workflow audits all locked npm packages in the library root,
including direct, transitive, development, optional and peer dependencies.
It runs daily at 05:29 UTC and can be started manually from Actions.
...
GitHub tarball URL and integrity in ha-eufy-cam, then test and release the bridge.
