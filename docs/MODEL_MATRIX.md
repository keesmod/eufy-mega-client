...
| Map geometry                                | Typed decoding of the three map files from the original parser's numbering, read from the app's product script on the owner's Mac on 2026-09-20 and validated against the retained captures of 2026-09-10, software evidence only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Coordinate and heading units and the `navPath.bin.stream` meaning are unconfirmed and display only, no fresh acquisition decoded end to end on the owned device                                                                                                                                                                                                                                                                                                                                                                               |
