...
hardware work is the mowing-progress source, the undecoded DP 107 values, any
dock, charging, idle or error payload and the first supervised setting change.
