...
unchanged. Settings and existing HA consumer behavior are outside this
evidence. Map decoding is recorded in
...
so the library has no DP 3 return route on firmware 6.9.28. Remaining hardware
work is the mowing-progress source, the undecoded DP 107 values and any dock,
charging, idle or error payload.
