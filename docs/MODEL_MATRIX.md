...
| Settings                                    | Declared points of mow height, volume, smart no-go zones, sparse lawn optimization, rain auto return, child lock and bird-view capture read on the owned E15 in a read-only readout on 2026-09-25 and matched to the official app's product script. Typed reading of all seven and opt-in writes of the first four with fresh-report read-back. Mow height 40 to 45 to 40 mm confirmed on the owned E15 on 2026-09-25 through Home Assistant and the mower bridge, each value read back by the library, a later fresh query and the app's Grass Height                                                                                          | Volume, smart no-go zones and sparse lawn optimization were not written on hardware, and no write ran while mowing, during a map save or at the bounds. Rain and child protection and the bird-view capture are read only, and the DP 155 work parameters are not written                                                                                                                                                                                                                                                                     |
...
supervised mow-height change and restore in the
