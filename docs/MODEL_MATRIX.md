...
| Settings                                    | Declared points of mow height, volume, smart no-go zones, sparse lawn optimization, rain auto return, child lock and bird-view capture read on the owned E15 in a read-only readout on 2026-09-25 and matched to the official app's product script. Typed reading of all seven and opt-in writes of the first four with fresh-report read-back, software evidence only                                                                                                                                                                                                                                                                          | No setting has been written on the owned device yet. The supervised mow-height change, read-back and restore is pending in keesmod/eufy-robomow-ha#8. Rain and child protection and the bird-view capture are read only, and the DP 155 work parameters are not written                                                                                                                                                                                                                                                                       |
...
[settings schema receipt](research/E15_SETTINGS_SCHEMA_2026-09-25.md). Remaining
hardware work is the mowing-progress source, any dock, charging or error
payload and the first supervised setting change. Since 0.22.0 DP 107 is read
