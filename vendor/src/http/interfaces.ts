...
export interface StationEvents {
  ...
  "parameter observed": (station: Station, type: number, value: string, source: SourceType) => void;
  ...
  "download complete": (station: Station, channel: number) => void;
  "livestream start": (
    station: Station,
    channel: number,
    metadata: StreamMetadata,
  ...
  "livestream no data": (station: Station, channel: number) => void;
