import type { ProtocolLogger } from "../logging";
...
export class ParameterHelper {
  ...
  public static readValue(serialNumber: string, type: number, value: string, log: Pick<ProtocolLogger, "debug">): string | undefined {
    if (value) {
