...
telemetry decoder, and a separate read-only map acquisition API. Physical
controls, confirmed E15 data-point definitions and decoded maps are not
delivered. See the [modular API](docs/API.md#modular-clients),
